...
public class MLexer {
  ...
  public MSetMarkerDeclaration newSetMarkerDeclaration(String pName) {
    MSetMarkerDeclaration lSetMarkerDeclaration = new MSetMarkerDeclaration(pName);
  ...
  public MAcceptMarkerDeclaration newAcceptMarkerDeclaration(String pName) {
    MAcceptMarkerDeclaration lAcceptMarkerDeclaration = new MAcceptMarkerDeclaration(pName);
