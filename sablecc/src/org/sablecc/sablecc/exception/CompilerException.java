...
public class CompilerException
    ...
    public static CompilerException invalidPriority(
        ...
        return new CompilerException(new MInvalidPriority(gt.getLine() + "",
                gt.getPos() + "", matchedToken.getName()).toString());
    }
    ...
    public static CompilerException conflictingPriorities(
        ...
        return new CompilerException(new MConflictingPriorities(gt.getLine()
                + "", gt.getPos() + "", high.getName(), low.getName(),
                prior_gt.getLine() + "", prior_gt.getPos() + "").toString());
    }
