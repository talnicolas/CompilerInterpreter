...
public class MConflictingPriorities {
  ...
  public MConflictingPriorities(String pLine, String pChar, String pHighToken, String pLowToken, String pContextLine, String pContextChar) {
    if(pLine == null) throw new NullPointerException();
    this.pLine = pLine;
    if(pChar == null) throw new NullPointerException();
    this.pChar = pChar;
    if(pHighToken == null) throw new NullPointerException();
    this.pHighToken = pHighToken;
    if(pLowToken == null) throw new NullPointerException();
