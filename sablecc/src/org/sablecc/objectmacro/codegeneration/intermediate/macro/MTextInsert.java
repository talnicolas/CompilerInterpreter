...
public class MTextInsert {
  ...
  public MTextInsert(String pName, String pIndent) {
  ...
  public MInlineTextArg newInlineTextArg(String pIndent) {
  ...
  public MParamInsertArg newParamInsertArg(String pName, String pIndent) {
  ...
  public MTextInsertArg newTextInsertArg(String pIndent) {
