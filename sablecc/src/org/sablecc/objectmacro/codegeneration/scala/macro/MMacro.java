...
public class MMacro {
  ...
  public MSelfRefMacro newSelfRefMacro() {
    MSelfRefMacro lSelfRefMacro = new MSelfRefMacro(mMacro);
    this.eSelfRefMacro_CheckParamNotNull_CheckAncestorParamNotNull_ExpandField.add(lSelfRefMacro);
    return lSelfRefMacro;
  }

  public MCheckParamNotNull newCheckParamNotNull(String pName) {
    MCheckParamNotNull lCheckParamNotNull = new MCheckParamNotNull(pName);
    this.eSelfRefMacro_CheckParamNotNull_CheckAncestorParamNotNull_ExpandField.add(lCheckParamNotNull);
    return lCheckParamNotNull;
  }

  public MCheckAncestorParamNotNull newCheckAncestorParamNotNull(String pName) {
    MCheckAncestorParamNotNull lCheckAncestorParamNotNull = new MCheckAncestorParamNotNull(pName);
    this.eSelfRefMacro_CheckParamNotNull_CheckAncestorParamNotNull_ExpandField.add(lCheckAncestorParamNotNull);
  ...
  public MExpandField newExpandField(String pName) {
    ...
    this.eSelfRefMacro_CheckParamNotNull_CheckAncestorParamNotNull_ExpandField.add(lExpandField);
    return lExpandField;
  }
  ...
  public MStringPart newStringPart(String pString) {
    ...
    this.eStringPart_EolPart_ParamInsertPart_TextInsertPart_ExpandInsertPart.add(lStringPart);
    return lStringPart;
  }

  public MEolPart newEolPart() {
    MEolPart lEolPart = new MEolPart();
    this.eStringPart_EolPart_ParamInsertPart_TextInsertPart_ExpandInsertPart.add(lEolPart);
    return lEolPart;
  }

  public MParamInsertPart newParamInsertPart(String pName) {
    MParamInsertPart lParamInsertPart = new MParamInsertPart(pName);
    this.eStringPart_EolPart_ParamInsertPart_TextInsertPart_ExpandInsertPart.add(lParamInsertPart);
    return lParamInsertPart;
  }

  public MTextInsertPart newTextInsertPart() {
    MTextInsertPart lTextInsertPart = new MTextInsertPart();
    this.eStringPart_EolPart_ParamInsertPart_TextInsertPart_ExpandInsertPart.add(lTextInsertPart);
  ...
  public MExpandInsertPart newExpandInsertPart(String pName) {
    ...
    this.eStringPart_EolPart_ParamInsertPart_TextInsertPart_ExpandInsertPart.add(lExpandInsertPart);
  ...
  public String toString() {
    ...
    sb.append(") {");
    sb.append(System.getProperty("line.separator"));
    if(this.eSelfRefMacro_CheckParamNotNull_CheckAncestorParamNotNull_ExpandField.size() > 0) {
      sb.append(System.getProperty("line.separator"));
    }
    for(Object oSelfRefMacro_CheckParamNotNull_CheckAncestorParamNotNull_ExpandField : this.eSelfRefMacro_CheckParamNotNull_CheckAncestorParamNotNull_ExpandField) {
      sb.append(oSelfRefMacro_CheckParamNotNull_CheckAncestorParamNotNull_ExpandField.toString());
    }
    sb.append(System.getProperty("line.separator"));
    ...
    sb.append(System.getProperty("line.separator"));
    {
      ...
      for(Object oStringPart_EolPart_ParamInsertPart_TextInsertPart_ExpandInsertPart : this.eStringPart_EolPart_ParamInsertPart_TextInsertPart_ExpandInsertPart) {
        ...
        sb.append(oStringPart_EolPart_ParamInsertPart_TextInsertPart_ExpandInsertPart.toString());
      }
    }
