...
public class MMacro {
  ...
  public MParamField newParamField(String pName) {
    ...
    this.eParamField_SelfRefMacro_AncestorField_ExpandField.add(lParamField);
    return lParamField;
  }

  public MSelfRefMacro newSelfRefMacro() {
    MSelfRefMacro lSelfRefMacro = new MSelfRefMacro(mMacro);
    this.eParamField_SelfRefMacro_AncestorField_ExpandField.add(lSelfRefMacro);
  ...
  public MAncestorField newAncestorField(String pName) {
    ...
    this.eParamField_SelfRefMacro_AncestorField_ExpandField.add(lAncestorField);
    return lAncestorField;
  }

  public MExpandField newExpandField(String pName) {
    MExpandField lExpandField = new MExpandField(pName);
    this.eParamField_SelfRefMacro_AncestorField_ExpandField.add(lExpandField);
    return lExpandField;
  }
  ...
  public MParamConstructorInit newParamConstructorInit(String pName) {
    MParamConstructorInit lParamConstructorInit = new MParamConstructorInit(pName);
    this.eParamConstructorInit_AncestorConstructorInit.add(lParamConstructorInit);
    return lParamConstructorInit;
  }

  public MAncestorConstructorInit newAncestorConstructorInit(String pName) {
    MAncestorConstructorInit lAncestorConstructorInit = new MAncestorConstructorInit(pName);
    this.eParamConstructorInit_AncestorConstructorInit.add(lAncestorConstructorInit);
  ...
  public String toString() {
    ...
    for(Object oParamField_SelfRefMacro_AncestorField_ExpandField : this.eParamField_SelfRefMacro_AncestorField_ExpandField) {
      sb.append(oParamField_SelfRefMacro_AncestorField_ExpandField.toString());
    }
    sb.append(System.getProperty("line.separator"));
    sb.append("  ");
