...
public class MMacroC {
  ...
  public MParamConstructorInit newParamConstructorInit(String pName) {
    ...
    this.eParamConstructorInit_SelfRefC_AncestorConstructorInit_ExpandConstructorInit.add(lParamConstructorInit);
    return lParamConstructorInit;
  }

  public MSelfRefC newSelfRefC() {
    MSelfRefC lSelfRefC = new MSelfRefC(mFile);
    this.eParamConstructorInit_SelfRefC_AncestorConstructorInit_ExpandConstructorInit.add(lSelfRefC);
    return lSelfRefC;
  }
  ...
  public MAncestorConstructorInit newAncestorConstructorInit(String pName) {
    ...
    this.eParamConstructorInit_SelfRefC_AncestorConstructorInit_ExpandConstructorInit.add(lAncestorConstructorInit);
  ...
  public MExpandConstructorInit newExpandConstructorInit(String pName) {
    ...
    this.eParamConstructorInit_SelfRefC_AncestorConstructorInit_ExpandConstructorInit.add(lExpandConstructorInit);
  ...
  public String toString() {
    ...
    for(Object oParamConstructorInit_SelfRefC_AncestorConstructorInit_ExpandConstructorInit : this.eParamConstructorInit_SelfRefC_AncestorConstructorInit_ExpandConstructorInit) {
      sb.append(oParamConstructorInit_SelfRefC_AncestorConstructorInit_ExpandConstructorInit.toString());
    }
    sb.append("  return m");
    sb.append(rFileName());
    sb.append(";");
