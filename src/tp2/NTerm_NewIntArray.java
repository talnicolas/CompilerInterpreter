...
public class NTerm_NewIntArray
    extends NTerm {
  ...
  public void apply(Walker walker) {
    walker.inTerm_NewIntArray(this);
    walker.caseTerm_NewIntArray(this);
    walker.outTerm_NewIntArray(this);
  }
  ...
  NTerm_NewIntArray(int line, int pos, N$28 pKeyword, N$15 p$15, N$7 pLBracket, NExp pExp, N$8 p$8) {
    this.line = line;
    this.pos = pos;
  ...
  @Override
  public Type getType() {
    return Type.T_Term_NewIntArray;
  }
  ...
  InternalType getInternalType() {
    return InternalType.T_Term_NewIntArray;
  }
